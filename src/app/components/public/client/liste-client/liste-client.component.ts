...
export class ListeClientComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.ser.getAllClients().subscribe(
      res => {
        ...
        let reg = ([... new Set(this.clt.map(obj => obj.Region))].filter(elem => elem != '')).filter(elem => elem != null)
        console.log(reg)
        for (let c of cat) {
  ...
  GetSelectedCat() {
    ...
    if (this.DDcat.value == null && this.DDcom.value == null && this.DDreg.value == null) {
      ...
      let reg = ([... new Set(this.dataTable.value.map(obj => obj.Region))].filter(elem => elem != '')).filter(elem => elem != null)
      for (let c of cat) {
        let x: SelectItem = { label: c, value: c }
        this.CatTarif.push(x)
      }
    ...
    if (this.DDcat.value != null) {
      ...
      let reg = ([... new Set(this.dataTable.filteredValue.map(obj => obj.Region))].filter(elem => elem != '')).filter(elem => elem != null)
      for (let c of cat) {
        let x: SelectItem = { label: c, value: c }
        this.CatTarif.push(x)
      }
    ...
    if (this.DDcom.value != null || this.DDreg.value != null) /*else*/ {
      let cat = [... new Set(this.dataTable.filteredValue.map(obj => obj.Categorie_Tarifaire))]
      let com = [...new Set(this.dataTable.filteredValue.map(item => item.Nom_Commercial))].filter(elem => elem != null)
      let reg = ([... new Set(this.dataTable.filteredValue.map(obj => obj.Region))].filter(elem => elem != '')).filter(elem => elem != null)
      this.CatTarif = []
  ...
  GetSelectedCom() {
    ...
    if (this.DDreg.value != null || this.DDcat.value != null) /*else*/ {
      let cat = [... new Set(this.dataTable.filteredValue.map(obj => obj.Categorie_Tarifaire))]
      let com = [...new Set(this.dataTable.filteredValue.map(item => item.Nom_Commercial))].filter(elem => elem != null)
      let reg = ([... new Set(this.dataTable.filteredValue.map(obj => obj.Region))].filter(elem => elem != '')).filter(elem => elem != null)
      this.CatTarif = []
  ...
  GetSelectedReg() {
    ...
    if(this.DDcat.value!=null || this.DDcom.value!=null) /*else*/ {
      let cat = [... new Set(this.dataTable.filteredValue.map(obj => obj.Categorie_Tarifaire))]
      let com = [...new Set(this.dataTable.filteredValue.map(item => item.Nom_Commercial))].filter(elem => elem != null)
      let reg = ([... new Set(this.dataTable.filteredValue.map(obj => obj.Region))].filter(elem => elem != '')).filter(elem => elem != null)
      this.CatTarif = []
